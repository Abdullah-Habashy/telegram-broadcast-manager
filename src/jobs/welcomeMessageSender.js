...
const { studentMenuOptionsAlways } = require('../bot/studentMenu');
  ...
  try {
    ...
    for (const row of pendingResult.rows) {
      ...
      try {
        ...
        const telegramMessage = await bot.telegram.sendMessage(row.chat_id, messageText, await studentMenuOptionsAlways(row.chat_id));
        await pool.query(
