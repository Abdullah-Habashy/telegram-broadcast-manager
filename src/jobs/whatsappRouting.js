...
// مزامنة طفرة كل ١٥ دقيقة، فالطالب اللي بيدوس Start قبل ما مزامنته توصل بيبان "مش مشترك"
// لحظة الإنشاء. الوظيفة دي بتشوف الحالة الحالية كل مرة، فبتصحّح نفسها لوحدها لما البيانات توصل.
//
