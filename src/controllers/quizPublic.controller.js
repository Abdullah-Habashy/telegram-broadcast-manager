...
// ---------- التظلّم ----------
//
// **إيه اللي يستاهل تظلم: المقالي بس** (قرار صاحب المشروع، ١٧ سبتمبر ٢٠٢٦).
// المقالي بيتصحّح بنموذج لغوي بيجتهد في المعنى، فالخطأ فيه وارد والمراجعة بتفرق.
// الاختيار من متعدد بيتصحّح بمقارنة رقم الخيار بالمفتاح — مفيش اجتهاد يتظلم منه.
//
// ⚠️ **وده بيقفل باب اتكشف بيه غلط حقيقي:** يوم ١١ سبتمبر ٢٠٢٦ كان فيه سبع أسئلة
// مفتاحها (أ) وهمي، وتلات طلاب خدوا صفر وإجابتهم صح — والتظلم هو اللي بيّن ده.
// البق ده اتصلّح، والبديل دلوقتي شاشة «إحصائيات الأسئلة»: السؤال اللي أغلب الطلاب
// وقعوا فيه بيطلع في أول القايمة، وده بيكشف المفتاح الغلط أوضح من تظلم فردي.
// **لو رجعنا نسمح بالاختياري، الشرط ده هو اللي يتشال — والصفحة بتفحص نفس الشرط.**
//
