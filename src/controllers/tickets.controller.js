...
//
// "الرد" هنا أوسع من رسالة الموظف. أي حاجة اتبعتت للطالب ده **هو شخصيًا** بتقفل الدور، سواء
// رد كتبه موظف، أو متابعة تلقائية، أو تفاعل بإيموجي على رسالته. المعيار إن الشات آخره حاجة
// مننا — ساعتها الكورة عند الطالب مش عندنا، ومفيش معنى إن الموظف يشوفه أحمر.
//
// الاستثناء الوحيد: **الإرسال الجماعي** (broadcast_recipient_id). الحملة بتروح لمئات الطلاب مرة
// واحدة ومالهاش علاقة بسؤال أي حد فيهم، فلو حسبناها رد كانت حملة واحدة هتمسح العلامة عن كل
// اللي مستنيين — وده يفضي اللون من معناه في لحظة.
//
