...
// سقف الرسايل في الجلسة الواحدة — **محكوم بحد مهلة Cloudflare (١٠٠ ثانية)**.
// النداء الواحد اتقاس على الإنتاج بـ ~٨ ثواني، فـ٤٠ سؤال بتوازي ٣ = ~١٠٧ ثانية = الطلب بيموت
// بـ 524 والأدمن مابيشوفش نتيجة رغم إن الجلسة اتحفظت في القاعدة فعلًا. ٢٤ بتوازي ٤ = ~٤٨ ثانية،
// نص المهلة تقريبًا. ومراجعة ٢٤ رد في قعدة واحدة هي أصلًا أقصى حاجة تتقرا بجد
const MAX_MESSAGES = 24;

// أربعة مع بعض. أكتر من كده مابيوفّرش كتير وبيزود الضغط على المفتاح المشترك مع الرد
// الآلي الحقيقي اللي بيرد على طلاب فعليين
const CONCURRENCY = 4;
