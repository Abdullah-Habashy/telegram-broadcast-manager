...
-- الكيبورد القديم (الزراير تحت مربع الكتابة) اتشال من عند الطالب ده ولا لأ.
-- الزراير اتنقلت للقايمة الزرقا، والكيبورد القديم بيفضل عند اللي شافوه لحد ما نشيله
...
INSERT INTO settings (key, value) VALUES
    ...
    -- **إشعار الدرجة على تيليجرام — مقفول بطلب صاحب المشروع (١٧ سبتمبر ٢٠٢٦).**
    -- الدرجة بتوصل الطالب أول ما ورقته تتصحّح، وده بيسبق مراجعة الفريق — فاتقفل.
    -- الطالب لسه بيشوف تصحيح ورقته لما يفتح رابط الاختبار بنفسه (`show_score_to_student`
    -- على الاختبار هو اللي بيتحكم في ظهور الرقم هناك).
    ('quiz_result_notify_enabled', 'false'),
